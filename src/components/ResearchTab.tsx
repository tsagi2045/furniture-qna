  ...
  return (
    <div className="flex flex-col gap-[var(--space-8)]">
      ...
      >
        ...
        >
          웹 리서치 기반 고객 VoC + 세그먼트·수요 분석 ({researchMeta.rawFiles.length}개 원본 파일,{" "}
          약 {researchMeta.totalSources}개 웹 소스 인용). 업데이트: {researchMeta.updatedAt}.
        </p>
      </div>
          ...
          <div className="flex flex-col gap-[var(--space-3)]">
            {section.cards.map((card, cardIdx) => (
              ...
              >
                ...
                {/* Summary bullets */}
                <ul className="flex flex-col gap-[var(--space-2)] mb-[var(--space-3)]">
                ...
                {card.quotes && card.quotes.length > 0 && (
                  <div className="flex flex-col gap-[var(--space-2)] mb-[var(--space-3)]">
